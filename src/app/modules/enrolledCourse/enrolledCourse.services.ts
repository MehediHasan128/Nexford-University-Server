...
const semesterRegistration = await SemesterRegistration.findById(isExistsOfferedCourse.semesterRegistration, {maxCredits: 1, _id: 0});
...
const newCourse = await Course.findById(isExistsOfferedCourse.course, {_id: 0, credits: 1});
